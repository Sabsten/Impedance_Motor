...
namespace ViewModel
{
    class Constantes
    {
        ...
        private double m_POSITION_DEPENDING_ON_TORQUE_SLOPE;
        public double POSITION_DEPENDING_ON_TORQUE_SLOPE { get { return m_POSITION_DEPENDING_ON_TORQUE_SLOPE; } }

        private double m_POSITION_DEPENDING_ON_TORQUE_TORQUE_SENSITIVITY;
        public double POSITION_DEPENDING_ON_TORQUE_TORQUE_SENSITIVITY { get { return m_POSITION_DEPENDING_ON_TORQUE_TORQUE_SENSITIVITY; } }

        private double m_POSITION_DEPENDING_ON_TORQUE_TORQUE_FLEXION_POINT;
        public double POSITION_DEPENDING_ON_TORQUE_TORQUE_FLEXION_POINT { get { return m_POSITION_DEPENDING_ON_TORQUE_TORQUE_FLEXION_POINT; } }

        private double m_POSITION_DEPENDING_ON_TORQUE_VMAX;
        public double POSITION_DEPENDING_ON_TORQUE_VMAX { get { return m_POSITION_DEPENDING_ON_TORQUE_VMAX; } }

        private double m_VELOCITY_DEPENDING_ON_POSITION_BACKWARD_SLOPE;
        public double VELOCITY_DEPENDING_ON_POSITION_BACKWARD_SLOPE { get { return m_VELOCITY_DEPENDING_ON_POSITION_BACKWARD_SLOPE; } }

        private double m_VELOCITY_DEPENDING_ON_POSITION_BACKWARD_TORQUE_SENSITIVITY;
        public double VELOCITY_DEPENDING_ON_POSITION_BACKWARD_TORQUE_SENSITIVITY { get { return m_VELOCITY_DEPENDING_ON_POSITION_BACKWARD_TORQUE_SENSITIVITY; } }

        private double m_VELOCITY_DEPENDING_ON_POSITION_BACKWARD_TORQUE_FLEXION_POINT;
        public double VELOCITY_DEPENDING_ON_POSITION_BACKWARD_TORQUE_FLEXION_POINT { get { return m_VELOCITY_DEPENDING_ON_POSITION_BACKWARD_TORQUE_FLEXION_POINT; } }

        private double m_VELOCITY_DEPENDING_ON_POSITION_BACKWARD_VMAX;
        public double VELOCITY_DEPENDING_ON_POSITION_BACKWARD_VMAX { get { return m_VELOCITY_DEPENDING_ON_POSITION_BACKWARD_VMAX; } }

        private double m_VELOCITY_DEPENDING_ON_POSITION_FORWARD_SLOPE;
        public double VELOCITY_DEPENDING_ON_POSITION_FORWARD_SLOPE { get { return m_VELOCITY_DEPENDING_ON_POSITION_FORWARD_SLOPE; } }

        private double m_VELOCITY_DEPENDING_ON_POSITION_FORWARD_TORQUE_SENSITIVITY;
        public double VELOCITY_DEPENDING_ON_POSITION_FORWARD_TORQUE_SENSITIVITY { get { return m_VELOCITY_DEPENDING_ON_POSITION_FORWARD_TORQUE_SENSITIVITY; } }

        private double m_VELOCITY_DEPENDING_ON_POSITION_FORWARD_TORQUE_FLEXION_POINT;
        public double VELOCITY_DEPENDING_ON_POSITION_FORWARD_TORQUE_FLEXION_POINT { get { return m_VELOCITY_DEPENDING_ON_POSITION_FORWARD_TORQUE_FLEXION_POINT; } }

        private double m_VELOCITY_DEPENDING_ON_POSITION_FORWARD_VMAX;
        public double VELOCITY_DEPENDING_ON_POSITION_FORWARD_VMAX { get { return m_VELOCITY_DEPENDING_ON_POSITION_FORWARD_VMAX; } }
        ...
        public Constantes()
        {
            ...
            m_POSITION_DEPENDING_ON_TORQUE_SLOPE = double.Parse(DataDictionary["POSITION_DEPENDING_ON_TORQUE_SLOPE"]);
            m_POSITION_DEPENDING_ON_TORQUE_TORQUE_SENSITIVITY = double.Parse(DataDictionary["POSITION_DEPENDING_ON_TORQUE_TORQUE_SENSITIVITY"]);
            m_POSITION_DEPENDING_ON_TORQUE_TORQUE_FLEXION_POINT = double.Parse(DataDictionary["POSITION_DEPENDING_ON_TORQUE_TORQUE_FLEXION_POINT"]);
            m_POSITION_DEPENDING_ON_TORQUE_VMAX = double.Parse(DataDictionary["POSITION_DEPENDING_ON_TORQUE_VMAX"]);
            m_VELOCITY_DEPENDING_ON_POSITION_BACKWARD_SLOPE = double.Parse(DataDictionary["VELOCITY_DEPENDING_ON_POSITION_BACKWARD_SLOPE"]);
            m_VELOCITY_DEPENDING_ON_POSITION_BACKWARD_TORQUE_SENSITIVITY = double.Parse(DataDictionary["VELOCITY_DEPENDING_ON_POSITION_BACKWARD_TORQUE_SENSITIVITY"]);
            m_VELOCITY_DEPENDING_ON_POSITION_BACKWARD_TORQUE_FLEXION_POINT = double.Parse(DataDictionary["VELOCITY_DEPENDING_ON_POSITION_BACKWARD_TORQUE_FLEXION_POINT"]);
            m_VELOCITY_DEPENDING_ON_POSITION_BACKWARD_VMAX = double.Parse(DataDictionary["VELOCITY_DEPENDING_ON_POSITION_BACKWARD_VMAX"]);
            m_VELOCITY_DEPENDING_ON_POSITION_FORWARD_SLOPE = double.Parse(DataDictionary["VELOCITY_DEPENDING_ON_POSITION_FORWARD_SLOPE"]);
            m_VELOCITY_DEPENDING_ON_POSITION_FORWARD_TORQUE_SENSITIVITY = double.Parse(DataDictionary["VELOCITY_DEPENDING_ON_POSITION_FORWARD_TORQUE_SENSITIVITY"]);
            m_VELOCITY_DEPENDING_ON_POSITION_FORWARD_TORQUE_FLEXION_POINT = double.Parse(DataDictionary["VELOCITY_DEPENDING_ON_POSITION_FORWARD_TORQUE_FLEXION_POINT"]);
            m_VELOCITY_DEPENDING_ON_POSITION_FORWARD_VMAX = double.Parse(DataDictionary["VELOCITY_DEPENDING_ON_POSITION_FORWARD_VMAX"]);
